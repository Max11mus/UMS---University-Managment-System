...
(personinfo_id, name_, surname, birth_date, login, email, avatar_path, hashed_password, time_zone)
...
(time_table_unit_id, location_id, lecture_id, begin_, end_)
