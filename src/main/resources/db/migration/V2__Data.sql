...
--- person_info
INSERT INTO ums.person_info
(personinfo_id, "name", surname, birth_date, login, email, avatar_path, hashed_password, time_zone)
VALUES('dc570bca-054b-4680-b2cc-6537b72e7945'::uuid, 'Frank', 'Parker', '1985-07-15', 'f_parker', 'f.parker@gmail.com', '', 'ff241ff70d46c8c858d2bae7d25ce777ce7ad8224f0a26a7cf890d893a052c08', 'UTC');
INSERT INTO ums.person_info
(personinfo_id, "name", surname, birth_date, login, email, avatar_path, hashed_password, time_zone)
VALUES('1b3ddf5f-2c72-47da-939d-6d87a78f65ca'::uuid, 'Brian', 'Stafford', '1993-01-03', 'b.stafford', 's.stafford@gmail.com', '', 'c24a4427638000149700d83eb40b84128028e9dfb570c410b6b002884067a0b8', 'GMT-5:00');
INSERT INTO ums.person_info
(personinfo_id, "name", surname, birth_date, login, email, avatar_path, hashed_password, time_zone)
VALUES('08226d3b-68dd-48aa-8dc6-cfe417409e03'::uuid, 'Donna', 'Cohen', '2003-05-07', 'd.cohen', 'd.cohen@gmail.com', '', '7f0485c93e4328b69b0b5f03a2b37cb73ef9838e9f3fdeb74c20474b1ea75e45', 'GMT+1:00');
INSERT INTO ums.person_info
(personinfo_id, "name", surname, birth_date, login, email, avatar_path, hashed_password, time_zone)
VALUES('9ad941cc-09c8-497e-b299-9244f34392a6'::uuid, 'Ivan', 'Moody', '1980-01-07', 'Ivan_Moody', 'Ivan_Moody@gmail.com', '', 'f9316e6d6ebe4f19475467382464fcac5acd8ec8f9343293067a4350d6a437ed', 'GMT-6:00');
INSERT INTO ums.person_info
(personinfo_id, "name", surname, birth_date, login, email, avatar_path, hashed_password, time_zone)
VALUES('b19bf0d4-3a73-4eff-bfe2-9a2217c3aa43'::uuid, 'Kathy', 'Mizer', '1977-08-06', 'Kathy$Mizer', 'Kathy$Mizer@gmail.com', '', '52fd199d620b29429bd44393a78a36b14ab1e607378488187f64e117f698e1d1', 'GMT+9:00');
INSERT INTO ums.person_info
(personinfo_id, "name", surname, birth_date, login, email, avatar_path, hashed_password, time_zone)
VALUES('5ab669f2-a8a1-4607-948c-0fc503fdc0d4'::uuid, 'Mary', 'Carpenter', '1973-01-11', 'Mary_Carpenter', 'Mary_Carpenter@gmail.com', '', '588b72cc2bb56563a0d7c4724dd6684fea8e4446b6f625a48ec1d17eac113f03', 'GMT-8:00');
INSERT INTO ums.person_info
(personinfo_id, "name", surname, birth_date, login, email, avatar_path, hashed_password, time_zone)
VALUES('fa808ce1-fd36-4b87-931c-fdfeaf08d61f'::uuid, 'Suzanne', 'Gallagher', '1973-10-20', 'Suzi.Gallagher', 'Suzi.Gallagher@gmail.com', '', '16ee854def2c30aa8b225a79d2c27bffb3111ab326bcfdec6dd6adb44eeaf9ed', 'GMT-6:00');
INSERT INTO ums.person_info
(personinfo_id, "name", surname, birth_date, login, email, avatar_path, hashed_password, time_zone)
VALUES('32f858fe-6ebf-4f2a-b6c9-43ce715ea320'::uuid, 'Richard ', 'Ortiz', '1997-04-18', 'R_Ortiz', 'R_Ortiz@gmail.com', '', 'ef2cb05f18494dbf2e27100f7ae03428b3ce7e7e7211d1c5e4c0db2259f70b8f', 'GMT-6:00');

--- Groups
INSERT INTO ums."group"
(group_id, "name")
...
(student_id, person_id, enroll_date, dropout_date, group_id)
VALUES('12611b1e-b277-4e64-8ff3-243a5d6fbc2d'::uuid, 'fa808ce1-fd36-4b87-931c-fdfeaf08d61f'::uuid, '2022-01-05', '2022-07-07', '91d2f442-fcd2-4d00-a23c-da207f75242d'::uuid);
INSERT INTO ums.student
(student_id, person_id, enroll_date, dropout_date, group_id)
VALUES('f57e0ffe-6118-44a8-b39d-b2da86b65aff'::uuid, '5ab669f2-a8a1-4607-948c-0fc503fdc0d4'::uuid, '2022-01-05', '2022-07-07', '91d2f442-fcd2-4d00-a23c-da207f75242d'::uuid);
INSERT INTO ums.student
(student_id, person_id, enroll_date, dropout_date, group_id)
VALUES('8cfe9e2c-7c4c-4b97-a590-bcc125eba4b7'::uuid, 'dc570bca-054b-4680-b2cc-6537b72e7945'::uuid, '2022-01-05', '2022-07-07', '80242a81-0ec9-48a4-98ff-90dd7550caf1'::uuid);
INSERT INTO ums.student
(student_id, person_id, enroll_date, dropout_date, group_id)
VALUES('b24d4f8d-f32f-4f88-a219-ebeb30568a1b'::uuid, '9ad941cc-09c8-497e-b299-9244f34392a6'::uuid, '2022-01-05', '2022-07-07', '80242a81-0ec9-48a4-98ff-90dd7550caf1'::uuid);
INSERT INTO ums.student
(student_id, person_id, enroll_date, dropout_date, group_id)
VALUES('c3e47148-adcf-4ee3-81f6-6b79b83a41ca'::uuid, 'b19bf0d4-3a73-4eff-bfe2-9a2217c3aa43'::uuid, '2022-01-05', '2022-07-07', 'bc2322d6-046b-4b1e-a757-b5cf26eff20a'::uuid);

--- Teachers
INSERT INTO ums.teacher
(teacher_id, person_id, academic_degree, employment_date)
VALUES('6e1e9867-4670-4520-8b85-7c195e72bd6c'::uuid, '08226d3b-68dd-48aa-8dc6-cfe417409e03'::uuid, 'Master of Science ', '2021-08-04');
INSERT INTO ums.teacher
(teacher_id, person_id, academic_degree, employment_date)
VALUES('210dd67b-7810-4edf-98be-e9a2cffe6290'::uuid, '1b3ddf5f-2c72-47da-939d-6d87a78f65ca'::uuid, 'Master of Science ', '2021-08-04');
INSERT INTO ums.teacher
(teacher_id, person_id, academic_degree, employment_date)
VALUES('d87a90ba-1237-419a-b199-19dc389b4bbf'::uuid, '32f858fe-6ebf-4f2a-b6c9-43ce715ea320'::uuid, 'Master of Science ', '2021-08-04');

--- Locations
INSERT INTO ums."location"
(location_id, address)
...
VALUES('22b4b0c8-a48d-4f1a-a8aa-a6335da452ed'::uuid, 'Object Oriented Design in Java', 'What is object-oriented design in software?
Результат пошуку зображень за запитом "java object oriented design what is"
...
(time_table_unit_id, location_id, lecture_id, "begin", "end")
...
INSERT INTO ums.time_table_unit_groups
